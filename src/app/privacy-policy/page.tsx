  ...
  return (
    <div className="container mx-auto max-w-4xl py-12 px-4 md:px-8">
      ...
      <div className="space-y-6 text-muted-foreground">
        <p>
          Your privacy is important to us. It is Tovy AI's policy to respect your privacy regarding any information we may collect from you across our website.
        </p>
        ...
        <ul className="list-disc list-inside space-y-2 pl-4">
          ...
          <li>Usage data, which may include information about how you use our website.</li>
        </ul>
        ...
        <h2 className="text-2xl font-semibold text-foreground pt-4">4. Your Rights</h2>
        <p>
          You have the right to be informed about the collection and use of your personal data. You have the right to access your personal data and have it corrected if it is inaccurate or incomplete. You can request the deletion of your personal data at any time. To exercise these rights, please contact us.
        </p>

        <h2 className="text-2xl font-semibold text-foreground pt-4">5. Cookies</h2>
        <p>
          We use cookies to help improve your experience of our website. A cookie is a small piece of data that our website stores on your computer, and accesses each time you visit, so we can understand how you use our site. This helps us serve you content based on preferences you have specified. At this time, we only use essential cookies for basic site functionality.
        </p>
