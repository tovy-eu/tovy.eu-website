          ...
          <div className="p-8 md:p-16 space-y-12 relative z-10">
            ...
            <section className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
                <div>
                  <p className="text-xs tracking-wide text-white/50 mb-2">{dict.pages.legalNotice.content.companyName}</p>
                ...
                <div>
                  <p className="text-xs tracking-wide text-white/50 mb-2">{dict.pages.legalNotice.content.representedBy}</p>
            ...
            <section className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
                <div>
                  <p className="text-xs tracking-wide text-white/50 mb-2">{dict.pages.legalNotice.content.email}</p>
                ...
                <div>
                  <p className="text-xs tracking-wide text-white/50 mb-2">{dict.pages.legalNotice.content.address}</p>
            ...
            <section className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div>
                  <p className="text-xs tracking-wide text-white/50 mb-2">{dict.pages.legalNotice.content.registry || "Registry"}</p>
                  <p className="text-sm font-bold text-white/80">{dict.pages.legalNotice.content.commercialRegistry || "Chamber of Commerce [KvK]"}</p>
                </div>
                <div>
                  <p className="text-xs tracking-wide text-white/50 mb-2">{dict.pages.legalNotice.content.kvkNumber || "KvK Number"}</p>
                ...
                <div>
                  <p className="text-xs tracking-wide text-white/50 mb-2">{dict.pages.legalNotice.content.vatNumber || "VAT ID"}</p>
                ...
                <div>
                  <p className="text-xs tracking-wide text-white/50 mb-2">{dict.pages.legalNotice.content.peppolId || "E-invoicing (Peppol)"}</p>
            ...
            <section className="space-y-4">
              <h3 className="font-mono text-xs tracking-wide text-white/20">
            ...
            <div className="pt-8 flex flex-col sm:flex-row gap-4">
              {downloadHref && (
                <Button asChild variant="outline" className="bg-white/[0.03] border-white/10 hover:bg-white/[0.06] text-white/60 hover:text-white rounded-full text-xs font-bold tracking-wide h-12 px-10 transition-all duration-500">
